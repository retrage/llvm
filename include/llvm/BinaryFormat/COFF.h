...
// FIXME: Define EBC specific Relocation types
enum RelocationTypeEBC : unsigned {
  IMAGE_REL_EBC_ABSOLUTE = 0x0000,
  IMAGE_REL_EBC_ADDR64 = 0x0001,
  IMAGE_REL_EBC_ADDR32 = 0x0002,
  IMAGE_REL_EBC_ADDR32NB = 0x0003,
  IMAGE_REL_EBC_REL32 = 0x0004,
  IMAGE_REL_EBC_REL32_1 = 0x0005,
  IMAGE_REL_EBC_REL32_2 = 0x0006,
  IMAGE_REL_EBC_REL32_3 = 0x0007,
  IMAGE_REL_EBC_REL32_4 = 0x0008,
  IMAGE_REL_EBC_REL32_5 = 0x0009,
  IMAGE_REL_EBC_SECTION = 0x000A,
  IMAGE_REL_EBC_SECREL = 0x000B,
  IMAGE_REL_EBC_SECREL7 = 0x000C,
  IMAGE_REL_EBC_TOKEN = 0x000D,
  IMAGE_REL_EBC_SREL32 = 0x000E,
  IMAGE_REL_EBC_PAIR = 0x000F,
  IMAGE_REL_EBC_SSPAN32 = 0x0010
};
